...
public class Batman extends Sprite {
    ...
    public Batman(World world, PlayScreen screen){
        ...
        for(int i = 1; i < 10; i++){
            frames.add(new TextureRegion(getTexture(), i * 52, 0, 52, 39));
        ...
        batmanStand = new TextureRegion(getTexture(), 70, 0, 31, 43); //FIX THIS WITH THE WORKING SPRITESHEET AND ADD THAT FRAME NUMBERS AND WIDTH HERE
...
//        shape.setRadius(3 / Main.PPM);
        ...
        shape.setAsBox(8 / Main.PPM, 7 / Main.PPM); // Testing
